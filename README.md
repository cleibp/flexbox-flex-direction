<h1 align="center"> 🚀 Flexbox | flex-direction </h1>
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/flexbox-flex-direction.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/ZEjRyQy) 
